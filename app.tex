...
\State Calcular $Rango_{Asc}$ para cada tarea, de acuerdo a (3) (4);
...
\subsection{GRASP}
\label{alg:grasp}
El procedimiento de búsqueda aleatoria glotona adaptativa (GRASP por sus siglas en inglés) es una heurística que se utiliza para resolver problemas de optimización combinatoria. De manera glotona, se construyen planificaciones que reduzcan del tiempo de ejecución total evaluado cada uno de los sucesores de una tarea dada. Así, el algoritmo escoge las tareas de manera aleatoria cuya variación en el tiempo no pase de un rango dado. El algoritmo termina hasta se cumple un criterio de terminación, como un tiempo límite. Este algoritmo fue propuesto por Blythe et al. \cite{blythe2005task}.
