...
\newcommand{\thesisTitle}{Estudio cualitativo de algoritmos de planificación de flujos de trabajo computacionales con apoyo de un simulador para su análisis cuantitativo}
