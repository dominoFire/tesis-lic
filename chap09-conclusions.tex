...
Con lo anterior, se puede concluir que planificar flujos de trabajo con un algoritmo es complejo, debido a la gran cantidad de factores que se tienen que tomar en cuenta; incluso, el algoritmo Miope tiene detalles que hace no trivial su implementación. Además, hay que notar que no existe un algoritmo que sea óptimo para todos los posibles flujos de trabajo, debido a que este problema es NP-completo. Aunque los resultados promedio sugieren que la diferencia en cuanto al tiempo total de ejecución que obtiene cada algoritmo es ligera, no hay que descartar el esfuerzo por estudiar y diseñar algoritmos de planificación de flujos de trabajo, ya que éstos pueden ser utilizados en otras aplicaciones como las cadenas de suministro.
