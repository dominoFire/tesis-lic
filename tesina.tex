...
%- el problema de calendarizacion con restricciones es NP-completo
%- hay muchas facetas del problema de calendarizacion, aqui solo se investigo complejidad y algunos algoritmos

%- el problema de calendarizacion es solo una parte a resolver cuando se trabaja con grids. Aun hay mucha investigacion de por medio

%- checa el FAQ sobre lo que hay que investigar de http://www.gridcomputing.com/gridfaq.html

%- big-data: el trend para el computo en la nube (http://www.cloudbus.org/)
