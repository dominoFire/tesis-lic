...
\begin{lstlisting}[language=java,label={code:myopic},caption={Código del algoritmo Miope},float]
List<Schedule> schedule(Workflow w, List<Resource> resourceList) {
